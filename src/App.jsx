...
const DEFAULT = [
  ...
  {
    type: "ab",
    a: { label: "HA IGEN – elismeri a problémát", they: "„Igen, sajnos ez nálunk is gond.”", you: "→ Folytasd a Hitelesség résszel lentebb" },
    b: { label: "HA NEM – nem ismeri el", they: "„Nem, ez nálunk nem jellemző.”", you: "„Örülök, hogy így van. Ha szabad megkérdeznem: jelenleg honnan jön az érdeklődők nagy része – ajánlás, vagy aktívan hirdetnek is valamit?”" },
  },
  {
    type: "sub-ab",
    title: "HA NEM ISMERI EL – következő kérdés után",
    a: { label: "HA AJÁNLÁSBÓL ÉL", they: "„Főleg ajánlásból érkeznek.”", you: "„Ez nagyon jól hangzik. A kérdés csak az, hogy ha holnap az egyik fő ajánló forrás kiesik, van-e más csatorna? Mert ezt szokák a cégek akkor meglépni, amikor már szűk a munka – mi azt javasoljuk, hogy előtte legyen kész a rendszer. Pont erről szólna az a 20 perc. Inkább hét eleje vagy vége jobb?”" },
    b: { label: "HA HIRDETNEK MÁR", they: "„Igen, hirdetünk is valamit.”", you: "„Melyik platformon fut jelenleg?” → Ha Facebook: „És az onnan jövő érdeklődők minősége hogyan alakul?” → Ha Google/egyéb: „Mi kifejezetten Facebookon dolgozunk, ahol az AI-alapú előszűrés sokkal pontosabban beállítható. Ez más megközelítés – pont ezt mutatnám meg. Mikor lenne jobb?”" },
  },
  ...
  { type: "you", text: "„Nem szeretnék most részletekbe menni telefonon – ez nem egy 10 perces pitch. Amit javaslok: egy 20 perces, kötetlen egyéztetes, ahol megmutatom pontosan hogyan működik a rendszer, önök pedig elmondhaják mi a jelenlegi helyzetük. Ha nem illik össze, nincs semmi következménye. Inkább a hét eleje vagy a vége jobb önöknek?”" },
  { type: "phase", label: "KIFOGÁSKEZELÉS" },
  { type: "objection", obj: "„Már próbáltuk a Facebook hirdetést, nem működött.”", resp: "„Ezt hallom a legtöbbször – és őszintén, az esetek nagy részében igaza van, mert általában nem szűrik az érdeklődőket előre. Mi éppen ebből a problémából indultunk ki. Megmutatom mi a különbség – ha 20 perc után azt mondja, nincs benne semmi új, szóljon. Mikor lenne jobb, kedd vagy csütörtök?”" },
  { type: "objection", obj: "„Nincs rá időm most, sok munkánk van.”", resp: "„Ez pontosan a legjobb szituáció erre – mert ha lassabb a szezon, akkor már kapkodni kell. 20 percet tudunk csinálni akár kora reggel is, ahogy kényelmes. Mikor lenne jobb?”" },
  { type: "objection", obj: "„Mennyibe kerül?”", resp: "„Ezt szándékosan nem mondanám most telefonon – mert attól függ, mekkora területet fednek le és milyen kapacitással dolgoznak. Ezt a 20 perces egyéztetesén szoktuk tisztázni. Mikor lenne ez jobb, hét elején vagy végén?”" },
  { type: "objection", obj: "„Küldjön emailt / majd visszahívom.”", resp: "„Szoktam emailt küldeni, de tapasztalatból tudom, hogy az építőiparban ez általában elvész. Inkább tegyük be a naptárba most – ha mégsem stimmel, lemondia, semmi gond. Kedd délelőtt vagy csütörtök délután jobb?”" },
  { type: "objection", obj: "„Nem érdekel a közösségi média / a hirdetés.”", resp: "„Teljesen érthétő. Amit mi csinálunk, az inkább egy lead-rendszer, mint klasszikus hirdetés. A platform csak az eszköz – a lényeg az, hogy ki jut el önökhöz és ki nem. Ez 20 perc alatt megítélhető. Hét eleje vagy vége jobb?”" },
  { type: "objection", obj: "„Van már marketingesünk / ügynökségünk.”", resp: "„Remek – akkor valószínűleg már látják, milyen érdeklődők jönnek. Azt mutatnám meg, hogyan egészíthető ki ez egy AI-alapú szűrővel, ami az érdeklődők minőségét javítja – függetlenül attól, ki futtatja a hirdetéseket. 20 perc – kedd vagy csütörtök jobb?”" },
];
...
function EditText({ value, onChange, editing }) {
  ...
  return (
    <textarea
      ...
      style={{ width: "100%", background: "rgba(232,97,42,0.1)", border: "1.5px solid #e8612a", borderRadius: 8, color: "#f0ece4", fontFamily: "inherit", fontSize: "inherit", lineHeight: "inherit", fontStyle: "inherit", padding: "6px 10px", outline: "none", resize: "vertical" }}
    />
  );
}
  ...
  const css = `
    ...
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    .phase{
      ...
      letter-spacing:0.28em;text-transform:uppercase;color:#e8612a;
    ...
    .you-tag{
      font-family:Syne,sans-serif;font-size:9px;font-weight:800;letter-spacing:0.15em;
      text-transform:uppercase;color:#e8612a;writing-mode:vertical-rl;
      transform:rotate(180deg);opacity:0.7;
    }
    .you-bubble{
      background:#181510;border-left:3px solid #e8612a;
      border-radius:0 14px 14px 0;padding:18px 22px;
      font-style:italic;font-size:15px;line-height:1.8;color:#f0ece4;flex:1;
    }
    ...
    .wait-pill{
      ...
      border-radius:8px;padding:7px 14px;font-size:12px;color:#4a4540;letter-spacing:0.03em;
    }
